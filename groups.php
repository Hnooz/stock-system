      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
                ...
                <div class="form-group">
                  <label for="group_name">اسم المجموعه</label>
                  <input type="text" class="form-control" id="group_name" name="group_name" placeholder="ادخل اسم المجموعة">
                </div>
                <div class="form-group">
                  ...
                  <table class="table table-responsive">
                    <thead>
                      <tr>
                        ...
                        <th style="text-align: right;">إضافة</th>
              ...
              <div class="box-footer">
                ...
                <a href="#" class="btn btn-warning">رجوع</a>
