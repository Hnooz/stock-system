...
<div class="row">
	<div class="col-md-12">
		...
		<ol class="breadcrumb">
		  <li><a href="dashboard.php">الرئيسيه</a></li>		  
...
<button class="btn btn-default button1" data-toggle="modal" id="addProductModalBtn" data-target="#addProductModal"> <i class="glyphicon glyphicon-plus-sign"></i> اضافة بيانات منج </button>
				...
				<table class="table table-bordered table-striped" id="manageProductTable">
					<thead>
						<tr>
							...
							<th style="text-align: right;">العلامة التجاريه</th>
